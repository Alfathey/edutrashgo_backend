...
<div class="col-lg-8 ">
    <form method="post" action="/dashboard/profile/{{$user->id}}" class="mb-5" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control  @error('name') is-invalid @enderror" id="name" name="name" required autofocus value="{{old('name', auth()->user()->name)}}" required>
            @error('name')
        ...
        <button type="submit" class="btn btn-primary d-block">Update Profile</button>
